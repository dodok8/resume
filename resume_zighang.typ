...
직행이 제가 가진 문제를 해결해줬기 때문이며, 저 또한 직행과 비슷하게 각 정보에 대한 접근성을 높여서 문제를 해결했던 경험이 있기 때문입니다. 2025년 2월 부로, 저는 취업 시장에 여러 고민과 함께 던져지게 되었습니다. 그 고민 중 하나는 어떤 취업 공고가 존재하느냐 였습니다. 한동안 제 하루 일과의 시작은 어떤 지원공고가 각 사이트에 올라왔느냐를 분석하는 것이었습니다. 단순하고, 반복적인 작업이었지만, 굉장히 실망스러운 작업이기도 했습니다. 요즘 같이 사람을 많이 뽑지 않는 시즌에서 저랑 맞는 공고를 찾는 것 자체가 하나의 일이었고 건진 것 하나 없는 하루가 되기도 했습니다. 그러다가 직행이라는 사이트를 알게 되었습니다. 그 덕분에 저는 매일 직접 사이트를 찾는 대신에 하루에 두 번 직행을 접속하는 것으로 대신하게 되었습니다.

단순히 직행이 제 고민을 해결해주었기에 직행에 지원하는 것만이 아닙니다. 직행처럼 정보를 분류하고 모으는 일, 정보에 대한 접근성을 높이는 일에 대한 가치를 알고 있기에 이 일에 지원하게 되었습니다. 저는 교내 개발자 행사인 GIST DEV NIGHT를 기획하면서, SmartX-Mini 실험 조교로서 실험 메뉴얼을 작성하면서, 조각나서 전해지던 정보들을 모으고 하나로 합쳐서 정리하는 일을 했었습니다. 이 과정에서 모으고 분류한 정보는 발표 주제, 실험 주제와 같이 굶직한 일도 있었지만, 테이블을 어떻게 배치해야 할지, 인삿말을 어떻게 건내야 할지, 포맷은 어떻게 진행해야하는지 같은 사소한 정보도 있었습니다. 그렇게 모인 정보는 사람들에게 영향을 미쳤습니다. GIST DEV NIGHT는 매년 계속해서 운영되면서 교내 개발자 컨퍼런스로 자리잡았고, 실험 자료는 매년 개선되어 더 원할한 실험 수업을 돕고 있습니다. 이렇듯 사소한 정보도 모으고, 접근하기 쉽게 만드는 것만으로도 변화를 만들 수 있었습니다다.

이러한 정보가 수천만명이 필요로 하고 원하는 정보라면 이를 더 사용하기 쉽게 만드는 것은 훨씬 더 커다란 힘을 발휘할 것입니다. 직행이 모으는 수많은 구인공고들은 그 정보에 해당합니다. 그래서 직행의 문제에 도전하고 싶습니다. 직행의 제품이 가치 있는 것을 이 채용공고를 포함한 각종 공고에 지원하면서 직접 느꼈왔고, 직행이 추구하는 가치와 비슷하게 정보를 모아서 접근하기 쉽게 해주는 것으로 문제를 해결한 경험이 있습니다. 그래서 저는 직행의 제품을 더 가치있게 만드는데 도전해 보고 싶습니다.
