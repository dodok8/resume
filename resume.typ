  ...
  (
    activityEntry(
      ...
      *\#오픈소스 기여* *\#코드 베이스 분석* *\#테스트 코드* *\#CI/CD*  *\#문서화* \
      ...
      - #link("https://github.com/fedify-dev/fedify/pull/282", "PR #282")
        - CLI 환경에서 터미널의 색상 지원 여부 감지 추가, 아스키 아트 컬러 출력 버그 수정
      - #link("https://github.com/fedify-dev/fedify/pull/299", "PR #299"), #link("https://github.com/fedify-dev/fedify/pull/308", "PR #308")
        - Cliffy 기반 명령어 `fedify node`의 테스트 추가 및 터미널의 컬러 지원 감지 로직 개선
      - #link("https://github.com/fedify-dev/fedify/pull/322", "PR #322")
        - 잘못된 workflow 구성으로 인한 알림 메세지 증가를 workflow 관리를 위한 저장소 분리로 해결
      - #link("https://github.com/fedify-dev/fedify/pull/327", "PR #327")
        - `fedify node` 명령어의 누락된 `--raw` 옵션 문서 추가
      - #link("https://github.com/fedify-dev/fedify/pull/331", "PR #331")
        - `fedify node`의 리네임 및 경고 메세지 추가
    ],
    activityEntry(
    ...
    activityEntry(from: datetime(year: 2025, month: 2, day: 22), title: pad(top: -1em / 4)[
      ...
      *\#오픈소스 운영* *\#CI/CD*  *\#AI 활용 개발* \
      ...
      - #link("https://github.com/dodok8/Ilots-log/pull/26", "PR #26")
    ...
    activityEntry(from: datetime(year: 2023, month: 12, day: 24), title: pad(top: -1em / 4)[
      ...
      *\#오픈소스 운영* *\#CI/CD* \
      ...
      - Fly.io 배포
        - Fly.io를 통한 배포로 GitHub 과 연동하여 편한 배포가 가능해짐
    ],
    activityEntry(from: datetime(year: 2022, month: 12, day: 21), title: pad(top: -1em / 4)[
      ...
      *\#팀 프로젝트* *\#코드 베이스 분석* *\#문서화*  \
      ...
      - Yarn berry 설정
        - Yarn Plugin 설정을 통한 `@types` 설치 자동화
    ],
