...
저희 부모님은 수십년 간 의류 소매업을 하고 계십니다. 그 오랜 시간, 옆에서 수많은 가게들이 사라졌다가 들어오는 광경 또한 지켜보았습니다. 사라지는 가게들은 다양한 이유로 사라져 가지만, 살아남는 가게들은 최소한의 공통점으로는 고객에게 만족을 주는 사용 경험이 있었습니다. 이용 과정에서 혼잡하지 않고, 좋은 상품을 제공하고, 결제 과정이 버벅이지 않는 그런 경험을 제공하는 가게들이 살아남았습니다. 이러한 경험을 어떻게 제공할 수 있을까라는 고민 또한 점주에게도 중요한 해결 과제입니다. 인력이 부족한 상황을 대응하기 위해 키오스크를 사용하고, 더 많은 결제 수단을 지원하는 것 또한 그 이유입니다. 이들을 한 단어로 묶는 다면, '만족스러운 경험' 이라는 단어가 될 것입니다.

토스플레이스의 사업은 이 좋은 경험을 보편화합니다. 첫 번째로, 점주에게 필요한 역량을 기술로 파악 할 수 있게 도와줍니다. 키오스크 모드, 배달 플랫폼 일원화 등 동선 최적화를 위한 기술 뿐만이 아닙니다. 재고관리, 고객 현황 파악과 관련된 기술은 오랜 시간 장사를 해온 저희 부모님도 토스플레이스에 관심을 가지게 만드셨습니다. 여기에 토스플레이스는 B2B 대상인 점주를 넘어, 점주의 대상인 고객을 만족시키는 사업을 합니다. 안정적인 결제와 다양한 플랫폼을 통한 결제 수단을 제공해서 만족스러운 경험을 제공합니다. 이러한 요소들이 결합되어서 앞서 말한 성공적인 가게에서 찾을 수 있는 그런 요소들이 됩니다.
