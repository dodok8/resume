...
이후부터는 GitHub-flow에 기반한 브랜치 관리 전략을 일괄적으로 도입했습니다. 또한 이슈에 따라 브랜치와 일을 분배하기 시작했습니다. 일반적인 GitHub-flow와 차이점은 메인과 구별되는 디벨롭 브랜치의 운영이었습니다. 디벨롭 브랜치의 용도는 메인과 별도로 배포를 진행하여 최종적인 문제점을 확인하는 용도였습니다. 그 이후에 메인에 머지하여 배포를 진행했습니다. 이를 통해 배포 시의 문제점을 더욱 명확하게 파악할 수 있었고, 다른 프로젝트에서 타입스크립트 마이그레이션 같은 대규모 작업을 시도할 수 있는 계기가 되었습니다.
