...
또한 토스플레이스는 점주와 고객을 잇는 오프라인 플랫폼입니다. 그리고 다른 토스의 사업에 비해서 초기 사업에 속해 있습니다. 그래서 변수가 많을 수밖에 없고, 그런 변수를 검증하기 위하여 카나리 릴리즈 같은 방식도 사용하고 있습니다. 이런 환경이면 의견과 의도 교환이 더 자주 일어나기 마련입니다. 이런 환경에서 그 의견과 의도를 코드에 반영하는 것, 그것이 프론트엔드 개발자로서 제 목표입니다. 그렇기에 저는 토스플레이스에서 오프라인과 온라인, 점주와 고객을 연결하는 개발을 하고 싶습니다.
