...
이렇듯 건전한 성과 관리와 피드백은 사람이 잘 떠나지 않고, 떠나더라도 좋은 점을 유지할 수 있는 팀을 만드는데 큰 기여를 합니다. 반대로, 성과 관리와 피드백이 없었던 팀들에서는 사람들이 금세 빠져나가고, 빠져나간 자리를 채우는데 오랜 시간이 걸리는 악순환이 이어졌습니다. 디웨일의 사업은 이런 성장 관리의 고민을 기술로 도와주는  있습니다. 그래서 저는 디웨일의 제품, 클랩에 관심을 가지고 싶습니다.
...
가장 중요한 성장은 GIST 재학 시절, 교내 개발자 조직인 인포팀에 합류한 시기였습니다. 앞에서 말씀 드린 인력 관리에 대한 교훈 말고도 개발 자체에 대한 교훈을 얻을 수 있었습니다. 바로 "실패에서 배우자"라는 교훈 이었습니다. 사실, 인포팀에서 만든 제품들은 제각기 다른 이유로 성공하지 못했습니다. 그렇지만 그 실패의 교훈을 기록으로 남겼고, 다른 사람의 도움을 받아서 정리하는 과정에서 실패에서 배우게 되었습니다.
...
두 번째 제품은  해당 사이트를 리액트로 다시 만드는 프로젝트였습니다. 개발이 길어지면서 이탈자가 학교와 개인의 일정에 따라 프로젝트 참가 인원이 변동되는 일이 많아졌습니다. 각자 자신이 맡은 부분만 이해하고 다른 사람의 코드에 대해 이해하지 못하는 일이 증가하여 추후 작업 분배에 악영향을 끼치게 되었습니다. 이런 상황이 지속되는 것을 막기 위해, PR 시 진행하는 코드 리뷰와 별개의 코드 리뷰를 진행하기로 했습니다. 또한 의사 결정 과정을 노션으로 남겨서 보다 명확하게 따라 잡을 수 있게 했습니다.
