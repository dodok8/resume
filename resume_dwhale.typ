...
우선 이탈자를 대비해서, 그리고 더 많은 프로덕트 확장을 대비해서 더 많은 인력을 뽑았습니다. 스터디 코스를 진행하는 동안 멘토-멘티를 도입해서 선배 개발자가 후배 개발자의 어려움을 관리하게 했습니다. 주먹구구식으로 운영되던 과거에서 벗어나 업무를 보다 세밀하게 나누고, 담당자를 정해서 관리하고 어디서 어려움을 겪는지 공유하게 했습니다. 서로의 성장에 긍정적인 피드백을 주고 이를 기록할 수 있는 슬랙봇을 도입하였습니다.

이런 관리가 쌓이고 나니, 인포팀은 더이상 흔들리는 조직이 아니었습니다. 더 많은 인원이 활발하게 제품에 대해서 의논하고, 실패한 제품의 교훈을 이어받아서 그를 극복하는 새로운 제품을 만드는 팀이 되었습니다. 사람이 떠나고 들어와도 팀의 좋은 면이 유지되는 건강한 팀이 되었습니다.
