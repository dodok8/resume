...
우선 이탈자와 프로덕트 확장을 대비해서 더 많은 인력을 뽑았습니다. 그렇게 늘어난 인력과 같이 스터디 코스를 진행하는 동안 멘토-멘티를 도입해서 선배 개발자가 후배 개발자의 어려움을 관리하게 했습니다. 업무를 시작할 때는는 주먹구구식으로 운영되던 과거에서 벗어나 업무를 보다 세밀하게 나누고, 담당자를 정해서 관리하고 어디서 어려움을 겪는지 공유하게 했습니다. 서로의 성장에 긍정적인 피드백을 주고 이를 기록할 수 있는 슬랙봇을 도입하였습니다.
