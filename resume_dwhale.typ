...
디웨일의 제품, 클랩은 HR의 문제를 기술로서 도와주려고 합니다. 회사 차원에서 사람이 조직에 있어서 얼마나 중요한지 알고 있기에 세울 수 있는 목표입니다. 앞에서 설명드린 팀원과 소통하는 개발자를 지향하면서, 그리고 여러 팀 프로젝트를 하면서 그 성장을 관리하는 것이 얼마나 중요한 일인지 알게 되었기 때문입니다.

저는 대학 시절에 교내 개발자 조직인 인포팀에 있었습니다. 처음 제가 들어갈 때는 4명 정도가 있는 작은 팀이었지만, 졸업할 때 쯤에는 그 3배의 인원이 활동하는 커다란 팀이 되어 여러 프로덕트를 운영하는 팀이 되었습니다. 이렇게 팀을 키우기 까지있어서 제일 큰 고민은 바로 이탈자였습니다. 대학생 집단이다 보니 시간이 지나면서 군대와 같은 사유로 이탈하는 경우가 많았습니다. 이 이탈자를 관리하는 것에서 부터 인력 관리에 대한 제 고민이 시작 되었습니다. 인포팀은 개발에 관심이 있는 사람이 모여서 운영되는 무급 팀이었기에, 소속을 강제 할 순 없었습니다. 그래서 반대로 접근했습니다. 떠나지 않을 이유를 만드는데 집중했습니다.

우선 이탈자와와 프로덕트 확장을 대비해서 더 많은 인력을 뽑았습니다. 그렇게 늘어난 인력과 같이 스터디 코스를 진행하는 동안 멘토-멘티를 도입해서 선배 개발자가 후배 개발자의 어려움을 관리하게 했습니다. 업무를 시작할 때는는 주먹구구식으로 운영되던 과거에서 벗어나 업무를 보다 세밀하게 나누고, 담당자를 정해서 관리하고 어디서 어려움을 겪는지 공유하게 했습니다. 서로의 성장에 긍정적인 피드백을 주고 이를 기록할 수 있는 슬랙봇을 도입하였습니다.

이런 관리가 쌓이자, 인포팀은 더이상 흔들리는 조직이 아니었습니다. 더 많은 인원이 활발하게 제품에 대해서 의논하고, 실패한 제품의 교훈을 이어받아서 그를 극복하는 새로운 제품을 만드는 팀이 되었습니다. 사람이 떠나고 들어와도 팀의 좋은 면이 유지되는 건강한 팀이 되었습니다.

이렇듯 건전한 성과 관리와 피드백은 사람이 잘 떠나지 않고, 떠나더라도 좋은 점을 유지할 수 있는 팀을 만드는데 큰 기여를 합니다. 반대로, 성과 관리와 피드백이 없었던 팀의 경우, 사람들이 금세 빠져나가고, 빠져나간 자리를 채우는데 오랜 시간이 걸리는 악순환이 이어졌습니다. 디웨일의 사업은 이런 성장 관리의 고민을 기술로 도와주고 있습니다. 그래서 저는 디웨일의 제품, 클랩에 관심을 가지게 되었습니다.

또한, 클랩은 팀과 회사 내부에서 소통의 도구이기도 합니다. 더 많은 소통과정에서 그 의도를 코드로 반영하는 것, 이 것은 제 프론트엔드 엔지니어로서의 목표이기도 합니다. 이런 소통의 도구에 기여하는 개발을 하고 싶어 지원하게 되었습니다.


=== 가장 큰 성장: 실패에서 배우자.

가장 중요한 성장은 GIST 재학 시절, 교내 개발자 조직인 인포팀에 있을 때였습니다. 이 시기에 저는 앞에서 말씀 드린 인력 관리에 대한 교훈 말고도 개발 자체에 대한 교훈을 얻을 수 있었습니다. 바로 "실패에서 배우자"라는 교훈이었습니다. 사실, 인포팀에서 만든 제품들은 제각기 다른 이유로 성공하지 못했습니다. 그렇지만 그 실패의 교훈을 기록으로 남겼고, 다른 사람의 도움을 받아서 정리하는 과정에서 실패에서 배우게 되었습니다.
