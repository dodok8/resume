...
저는 대학 시절에 교내 개발자 조직인 인포팀에 있었습니다. 처음 제가 들어갈 때는 4명 정도가 있는 작은 팀이었지만, 졸업할 때 쯤에는 그 3배의 인원이 활동하는 커다란 팀이 되어 여러 프로덕트를 운영하는 팀이 되었습니다. 이렇게 팀을 키우기까지있어서 제일 큰 고민은 바로 이탈자였습니다. 대학생 집단이다 보니 시간이 지나면서 군대와 같은 사유로 이탈하는 경우가 많았습니다. 이 이탈자를 막는 것에서 부터 인력 관리에 대한 제 고민이 시작 되었습니다. 인포팀은 개발에 관심이 있는 사람이 모여서 운영되는 무급 팀이었기에, 소속을 강제 할 순 없었습니다. 그래서 반대로 접근했습니다. 떠나지 않을 이유를 만드는데 집중했습니다.

우선 이탈자와 프로덕트 확장을 대비해서 더 많은 인력을 뽑았습니다. 그렇게 늘어난 인력과 같이 스터디 코스를 진행하는 동안 멘토-멘티를 도입해서 선배 개발자가 후배 개발자의 어려움을 관리하게 했습니다. 업무를 시작할 때 주먹구구식으로 운영되던 과거에서 벗어나 업무를 보다 세밀하게 나누고, 담당자를 정해서 관리하고 어디서 어려움을 겪는지 공유하게 했습니다. 서로의 성장에 긍정적인 피드백을 주고 이를 기록할 수 있는 슬랙봇을 도입하였습니다.
